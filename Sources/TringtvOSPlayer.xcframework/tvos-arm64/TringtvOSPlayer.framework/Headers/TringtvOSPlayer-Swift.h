...
#ifndef TRINGTVOSPLAYER_SWIFT_H
#define TRINGTVOSPLAYER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TringtvOSPlayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15TringtvOSPlayer15TringPlayerView")
@interface TringPlayerView : UIView
...
SWIFT_CLASS("_TtC15TringtvOSPlayer10TvOSSlider")
